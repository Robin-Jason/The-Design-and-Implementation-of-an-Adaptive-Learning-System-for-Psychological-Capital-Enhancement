	...
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="info-item5" v-if="userTableName=='yonghu'">
				...
				<div class="text">{{sessionForm.jifen}}</div>
			</div>
		...
		<el-tabs class="center-tabs" tab-position="left" @tab-click="handleClick">
			...
			<el-tab-pane label="我的学习"></el-tab-pane>
		</el-tabs>
...
<script>
	...
	export default {
		...
		created() {
			...
			if ('yonghu' == this.userTableName) {
				this.$set(this.rules, 'jifen', [{ required: false, validator: this.$validate.isNumber, trigger: 'blur' }]);
			}
