<template>
	...
	<div class="section-title" :style='{"margin":"10px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20241127/0acd634bb5d34165a420a799b58e4f17.png) 100% 100%/cover no-repeat","fontSize":"24px","lineHeight":"100px","fontWeight":"bold","height":"80px"}'>我的发布</div>
