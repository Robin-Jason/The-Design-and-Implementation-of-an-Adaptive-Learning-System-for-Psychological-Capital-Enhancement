<template>
	<div :style='{"width":"100%","padding":"20px 30px","fontSize":"15px"}'>
		...
		>
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}'   v-if="flag=='yonghu'"  label="手机号码" prop="shoujihaoma">
					<el-input v-model="ruleForm.shoujihaoma" 						placeholder="手机号码" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}'   v-if="flag=='yonghu'"  label="积分" prop="jifen">
