...
<!--						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">试卷名称</label>-->
...
<!--					<el-button class="add" v-if="isAuth('scoredetermination','新增')" type="success" @click="addOrUpdateHandler()">-->
<!--						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>-->
<!--						添加-->
<!--					</el-button>-->
<!--					<el-button class="del" v-if="isAuth('scoredetermination','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">-->
<!--						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>-->
<!--						删除-->
<!--					</el-button>-->
...
<!--					:border='true'-->
<!--					v-if="isAuth('scoredetermination','查看')"-->
<!--					:data="dataList"-->
...
<!--						<template slot-scope="scope">-->
<!--							<el-button class="view" v-if=" isAuth('scoredetermination','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">-->
<!--								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>-->
<!--								查看-->
<!--							</el-button>-->
<!--							<el-button class="edit" v-if=" isAuth('scoredetermination','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">-->
<!--								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>-->
<!--								修改-->
<!--							</el-button>-->
...
<!--							<el-button class="del" v-if="isAuth('scoredetermination','删除') " type="primary" @click="deleteHandler(scope.row.id )">-->
<!--								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>-->
<!--								删除-->
<!--							</el-button>-->
<!--						</template>-->
