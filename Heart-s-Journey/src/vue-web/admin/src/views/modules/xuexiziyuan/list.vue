<template>
	<div class="main-content" :style='{"width":"100%","padding":"20px 30px","fontSize":"15px"}'>
		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #fff","width":"100%","padding":"0 20px 20px","fontSize":"14px","color":"#000","background":"#fff"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' prop="xuexishipin" label="学习视频">
						<template slot-scope="scope">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('xuexiziyuan','学习反馈')" @click="xuexifankuiCrossAddOrUpdateHandler(scope.row,'cross','','','[1]','已学习')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								学习反馈
							</el-button>
		...
		<xuexifankui-cross-add-or-update v-if="xuexifankuiCrossAddOrUpdateFlag" :parent="this" ref="xuexifankuiCrossaddOrUpdate"></xuexifankui-cross-add-or-update>
...
<script>
	...
	import xuexifankuiCrossAddOrUpdate from "../xuexifankui/add-or-update";
	import {
		Loading
	} from 'element-ui';
	export default {
		data() {
			return {
				...
				xuexifankuiCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			xuexifankuiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.xuexifankuiCrossAddOrUpdateFlag = true;
				this.$storage.set('crossObj',row);
				this.$storage.set('crossTable','xuexiziyuan');
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.xuexifankuiCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.xuexifankuiCrossaddOrUpdate.init(row.id,type);
				});
			},
