	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="date" v-if="type!='info'" label="学习时间" prop="xuexishijian" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.xuexishijian" label="学习时间" prop="xuexishijian" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="学习感悟" prop="fankuijianyi" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.fankuijianyi" label="学习感悟" prop="fankuijianyi" >
				<span class="text">{{ruleForm.fankuijianyi}}</span>
			</el-form-item>
